      ...
      <div>
        <div className='d-flex' style={{justifyContent:"space-between"}}>
          <div className='iframe-container'>
            <iframe src="https://go.echo3d.co/138n" scrolling='no'>
            </iframe>
          </div>
          ...
          <a href='https://go.echo3d.co/138n' target='blank' style={{padding:"5px", color:"white"}}>Full View in AR</a>
          </p>
        </div>
        
        <div className='d-flex' style={{justifyContent:"space-between", marginTop:"-200px"}}>
          <div className='iframe-container'>
            <iframe src="https://go.echo3d.co/WnVp" scrolling='no'>
            </iframe>
          </div>
          <p style={{height:"500px", width:"700px"}}>
          <h4>Clown Fish</h4>
          ...
          <a href='https://go.echo3d.co/WnVp' target='blank' style={{padding:"5px", color:"white"}}>Full View in AR</a>
          </p>
        </div>

        <div className='d-flex' style={{justifyContent:"space-between", marginTop:"-200px"}}>
          <div className='iframe-container'>
            <iframe src="https://go.echo3d.co/jdaC" scrolling='no'>
            </iframe>
          </div>
          <p style={{height:"500px", width:"700px"}}>
          <h4>Manta Ray</h4>
          ...
          <a href='https://go.echo3d.co/jdaC' target='blank' style={{padding:"5px", color:"white"}}>Full View in AR</a>
          </p>
          </div>
        </div> 
